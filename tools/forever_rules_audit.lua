...
assert(FR.VERSION == 4)
assert(FR.ID == "FOREVER_CLASSIC_BETA_V4")
...
assert(warrior.maxMana == 0, "Rage Warrior must not gain a hidden mana pool from Intellect")
...
print("Forever rules audit OK: Classic class rows, stamina HP, zero Warrior mana, AP, armor, attack tables, block value and normalized Rage verified.")
