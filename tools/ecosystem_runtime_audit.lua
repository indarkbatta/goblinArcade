...
GA.StudioData = {
    ...
    ecosystems = {
        { id = "orc", name = "Orc", dungeonName = "ORC CRYPT", enabled = "YES", weight = 70, stylePreset = "ORC_CRYPT" },
        { id = "kobold", name = "Kobold", dungeonName = "KOBOLD WARREN", enabled = "YES", weight = 30, stylePreset = "WARREN" },
    },
    ecosystemEnemies = {
...
assert(GA.DungeonGenerator.VERSION == 15, "Unexpected DungeonGenerator version")
...
print("Ecosystem runtime audit OK: one deterministic ecosystem per 9-floor run, filtered monster plans, filtered events and style metadata.")
